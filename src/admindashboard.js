  ...
  return (
    <div>
      ...
      <div className='counts'>
        <div className='box'>Active Customer:
          <div>{custs.length}</div>
        </div>
 
        <div className='box'>Approved Policy:
          <div>{approve.length}</div>
        </div>
 
        <div className='box'>Dissapproved Policy:
          <div>{reject.length}</div>
        </div>
 
        <div className='box'>Buying Request:
          <div>{buyingrequest.length}</div>
        </div>
        <div className='box'>Claim Request:
