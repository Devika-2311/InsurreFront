    ...
    <div className="payment-history-page">
      <div className="payment-history-container">
        ...
        <div className="filters">
          <label>
            Filter by year:
            <input type="number" value={filterYear} onChange={handleYearChange} placeholder="Select a year" />
          </label>
          <label>
            Filter by month:
            <input type="number" value={filterMonth} onChange={handleMonthChange} placeholder="Select a month" />
          </label>
        </div>
